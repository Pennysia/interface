        ...
        <div className="p-6 pb-8">
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            <button
              ...
              className="w-full bg-gray-800 dark:bg-gray-100 dark:text-black hover:bg-gray-700 dark:hover:bg-gray-300 text-white py-4 px-6 rounded-xl font-semibold transition-colors hover:cursor-pointer"
            >
              Manage Direction
            </button>
          </div>
