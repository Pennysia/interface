...
export default function LiquidityPositionCard({
  ...
  return (
    <div
      ...
      className="w-full max-w-2xl border border-gray-300 dark:border-gray-800  rounded-xl py-4 px-6 hover:bg-gray-100 dark:hover:bg-gray-900/50 transition-all duration-200 cursor-pointer group"
    >
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          ...
          <div className="bg-gray-200/30 dark:bg-gray-800/30 rounded-lg p-3">
            <div className="flex items-center space-x-2 mb-2">
              <span className="text-gray-900 dark:text-white font-medium">
                {position.token0Symbol}-LPTokens
              </span>
            </div>
          ...
          <div className="bg-gray-200/30 dark:bg-gray-800/30 rounded-lg p-3">
            <div className="flex items-center space-x-2 mb-2">
              <span className="text-gray-900 dark:text-white font-medium">
                {position.token1Symbol}-LP Tokens
              </span>
            </div>
            <div className="space-y-1">
              <div className="flex justify-between text-sm">
